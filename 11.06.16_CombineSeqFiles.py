...
seqFile1 = open("9.20.16_ParkKOA.mutpos", "r")
seqFile2 = open("9.20.16_ParkKOB.mutpos", "r")
seqFile3 = open("9.20.16_ParkKOC.mutpos", "r")
seqFile4 = open("9.20.16_ParkKOD.mutpos", "r")
seqFile5 = open("9.20.16_ParkKOE.mutpos", "r")
combinedfile = open("9.20.16_ParkKOCombined.txt", "w")
